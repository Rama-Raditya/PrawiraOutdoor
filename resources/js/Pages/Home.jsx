    ...
    return (
        <>
            ...
            <section className="py-12 sm:py-16 bg-gray-50 relative overflow-hidden">
                ...
                <div 
                    className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-deep-green/10 to-sand/10 rounded-full blur-3xl"
                    style={{ 
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="bg-white p-6 sm:p-8 rounded-lg shadow-xl transform hover:scale-105 transition-transform duration-300">
                            <div className="flex items-center mb-4">
                                ...
                                />
                                <div>
                                    <h4 className="font-semibold text-base sm:text-lg">{testimonials[activeTestimonial].name}</h4>
                                    <div className="flex">
                                        {[...Array(5)].map((_, i) => (
                                            <Star 
                                                key={i} 
                                                size={16} 
                                                className={`transition-all ${i < testimonials[activeTestimonial].rating ? "text-yellow-400 fill-current" : "text-gray-300"}`}
                                            />
                                        ))}
                                    </div>
                                </div>
                            </div>
                            <p className="text-sm sm:text-base text-gray-600 italic">"{testimonials[activeTestimonial].comment}"</p>
                        </div>
                        ...
                        <div className="flex justify-center mt-6 space-x-2">
                            {testimonials.map((_, index) => (
                                <button
                                    ...
                                    className={`w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full transition-all duration-300 transform ${index === activeTestimonial ? 'bg-deep-green scale-125' : 'bg-gray-300 hover:bg-gray-400'}`}
                                />
                            ))}
                        </div>
                    </div>
            ...
            <section className="py-12 sm:py-16 bg-deep-green relative overflow-hidden">

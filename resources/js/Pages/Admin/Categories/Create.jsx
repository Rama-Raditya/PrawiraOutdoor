            ...
            <div className="bg-gray-50 min-h-screen">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="mb-8">
                        ...
                        <h1 className="text-3xl font-bold text-deep-green mb-2">Tambah Kategori Baru</h1>
                        <p className="text-gray-600">Tambahkan kategori untuk mengelompokkan produk</p>
                    </div>

...
const ItemsEdit = ({ auth, item, categories }) => {
            ...
            <div className="bg-gray-50 min-h-screen">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="mb-8">
                        ...
                        <h1 className="text-3xl font-bold text-deep-green mb-2">Edit Produk</h1>
                        <p className="text-gray-600">Perbarui informasi produk {item.name}</p>
                    </div>
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mt-6 flex justify-end">
                                ...
                                >
                                    {processing ? 'Simpan Perubahan' : 'Menyimpan...'}
                                </button>
                            </div>
                        </form>
                    </div>
